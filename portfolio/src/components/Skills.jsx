        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto w-full">
                ...
                <div className="text-center mb-20 px-2">
                    <h2 className="font-syne text-[clamp(1.2rem,6vw,4rem)] md:text-8xl font-black mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent whitespace-nowrap overflow-visible">
                        Skills & Technologies
                    </h2>
