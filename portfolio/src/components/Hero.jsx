        ...
        >
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 text-center">
                ...
                <div ref={textRef} className="mb-8 perspective-1000 flex flex-col items-center">
                    <h1 className="block w-fit mx-auto font-syne text-[clamp(2rem,10vw,4.5rem)] sm:text-6xl md:text-[clamp(3rem,6.5vw,7.5rem)] font-black leading-[0.9] md:leading-[0.85] tracking-tight mb-2 md:mb-4 px-4">
                    ...
                    <h1 className="block w-fit mx-auto font-syne text-[clamp(2rem,10vw,4.5rem)] sm:text-6xl md:text-[clamp(3rem,6.5vw,7.5rem)] font-black leading-[0.9] md:leading-[0.85] tracking-tight px-4">
