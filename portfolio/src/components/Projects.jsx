                ...
                <div className="relative z-10 flex flex-col lg:flex-row gap-8 lg:gap-12 p-6 lg:p-10">
                    ...
                    <div className="lg:w-1/2 flex flex-col justify-center">
                        ...
                        <div className="flex items-center gap-6 mt-auto">
                            ...
                            <a href={project.links.code} target="_blank" rel="noopener noreferrer" className="p-3 bg-white/5 rounded-full hover:bg-white/10 hover:text-blue-400 transition-all">
